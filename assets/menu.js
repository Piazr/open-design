document.addEventListener('DOMContentLoaded', () => {
  ...
  if (['preface.html', 'copyright.html', '01.html', '02.html', '03.html', '04.html'].includes(filename)) {
    ...
    activePartIndex = 2;
  } else if (['09.html', '10.html'].includes(filename)) {
    activePartIndex = 3;
    ...
    <div id="menu-drawer">
      ...
      <div id="drawer-body" class="flex-1 overflow-y-auto select-none bg-transparent">
        ...
        <div class="flex flex-col divide-y divide-black bg-transparent">
          ...
          <!-- PART 1: Foundations & Core Skills -->
          <div class="menu-part-section border-b border-black" data-part="1">
            <button class="menu-part-btn">
              ...
              <span class="nav-text-wrapper text-2xl sm:text-3xl font-bold tracking-tight">
                <span class="nav-text">Foundations & Core Skills <sup class="font-mono text-xs text-black/40">01</sup></span>
                <span class="nav-text-clone">Foundations & Core Skills <sup class="font-mono text-xs text-white/60">01</sup></span>
              </span>
            ...
            <div class="menu-part-content hidden bg-white/25 px-6 py-4 flex flex-col gap-2 font-mono text-xs">
              ...
              <a href="${resolveLink('chapters/01.html')}" class="${getLinkClass('01.html')}">Ch 01: The Design-Code Gap</a>
              <a href="${resolveLink('chapters/02.html')}" class="${getLinkClass('02.html')}">Ch 02: Getting Started (No Terminal Fear)</a>
              <a href="${resolveLink('chapters/03.html')}" class="${getLinkClass('03.html')}">Ch 03: Your First Design Prototype</a>
              <a href="${resolveLink('chapters/04.html')}" class="${getLinkClass('04.html')}">Ch 04: The Art of Prompting for Design</a>
            </div>
          </div>

          <!-- PART 2: System & Workflow Automation -->
          <div class="menu-part-section border-b border-black" data-part="2">
            <button class="menu-part-btn">
              ...
              <span class="nav-text-wrapper text-2xl sm:text-3xl font-bold tracking-tight">
                <span class="nav-text">System & Automation <sup class="font-mono text-xs text-black/40">02</sup></span>
                <span class="nav-text-clone">System & Automation <sup class="font-mono text-xs text-white/60">02</sup></span>
              </span>
              <i data-lucide="plus" class="menu-part-icon size-5"></i>
            </button>
            <div class="menu-part-content hidden bg-white/25 px-6 py-4 flex flex-col gap-2 font-mono text-xs">
              <a href="${resolveLink('chapters/05.html')}" class="${getLinkClass('05.html')}">Ch 05: Teaching Claude Your Design Language</a>
              <a href="${resolveLink('chapters/06.html')}" class="${getLinkClass('06.html')}">Ch 06: Design Systems at Scale</a>
              <a href="${resolveLink('chapters/07.html')}" class="${getLinkClass('07.html')}">Ch 07: Automating Design Workflows</a>
              <a href="${resolveLink('chapters/08.html')}" class="${getLinkClass('08.html')}">Ch 08: Connecting Your Design Tools</a>
            </div>
          </div>

          <!-- PART 3: Production & Tool Landscape -->
          <div class="menu-part-section border-b border-black" data-part="3">
            <button class="menu-part-btn">
              ...
              <span class="nav-text-wrapper text-2xl sm:text-3xl font-bold tracking-tight">
                <span class="nav-text">Production & Tools <sup class="font-mono text-xs text-black/40">03</sup></span>
                <span class="nav-text-clone">Production & Tools <sup class="font-mono text-xs text-white/60">03</sup></span>
              </span>
              <i data-lucide="plus" class="menu-part-icon size-5"></i>
            </button>
            <div class="menu-part-content hidden bg-white/25 px-6 py-4 flex flex-col gap-2 font-mono text-xs">
              <a href="${resolveLink('chapters/09.html')}" class="${getLinkClass('09.html')}">Ch 09: From Design to Production</a>
              <a href="${resolveLink('chapters/10.html')}" class="${getLinkClass('10.html')}">Ch 10: The AI Design Tool Landscape</a>
            </div>
          </div>
          ...
          <div class="menu-part-section border-b border-black" data-part="4">
            <button class="menu-part-btn">
              ...
              <span class="nav-text-wrapper text-2xl sm:text-3xl font-bold tracking-tight">
                <span class="nav-text">Appendices <sup class="font-mono text-xs text-black/40">04</sup></span>
                <span class="nav-text-clone">Appendices <sup class="font-mono text-xs text-white/60">04</sup></span>
              </span>
              <i data-lucide="plus" class="menu-part-icon size-5"></i>
            </button>
            <div class="menu-part-content hidden bg-white/25 px-6 py-4 flex flex-col gap-2 font-mono text-xs">
              <a href="${resolveLink('chapters/A.html')}" class="${getLinkClass('A.html')}">Appendix A: Claude Code Command Reference</a>
              <a href="${resolveLink('chapters/B.html')}" class="${getLinkClass('B.html')}">Appendix B: Pricing, Plans, and Limits</a>
              <a href="${resolveLink('chapters/C.html')}" class="${getLinkClass('C.html')}">Appendix C: Troubleshooting and FAQ</a>
            </div>
          </div>
